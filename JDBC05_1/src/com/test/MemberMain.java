...
지역 (강원/경기/경남/경북/부산/서울/인천/전남/전북/제주/충남/충북/) : 경기		--> 지역을 삭제하거나 추가할 경우 보이게끔 구성
전화번호 : 010-1111-1111
부서(개발부/기획부/영업부/인사부/자재부/총무부/홍보부/) : 	개발부				--> 부서를 삭제하거나 추가할 경우 보이게끔 구성
직위(사장/전무/상무/이사/부장/차장/과장/대리/사원/) : 대리						--> 직위를 삭제하거나 추가할 경우 보이게끔 구성
기본급(최소 1800000 이상) : 2500000											--> 대리로 입력했으면 대리의 최소 기본급이 보이게끔
수당 : 1000000
...
public class MemberMain
{
	public static void main(String[] args)
	{
		...
		do
		{
			...
			System.out.println("   - 사번 오름차순 정렬");
			System.out.println("   - 이름 오름차순 정렬");
			System.out.println("   - 부서 오름차순 정렬");
			System.out.println("   - 직위 오름차순 정렬");
