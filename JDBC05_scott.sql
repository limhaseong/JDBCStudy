...
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '상무', 3500000);  -- 삼백오심만
...
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY) VALUES(JIKWISEQ.NEXTVAL, '사원', 1650000);  -- 백육십오만
--==> 1 행 이(가) 삽입되었습니다. * 9
...
--○ 확인
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG, SAL FROM (SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG, (BASICPAY + SUDANG) AS SAL FROM TBL_EMP) ORDER BY SAL DESC
;
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG FROM TBL_EMP ORDER BY EMP_NAME ASC;
/*
...
UPDATE TBL_EMP
SET EMP_NAME = '엄재용', SSN = '950111-1053116', IBSADATE = 'YYYY-MM-DD', CITY_ID = 1, TEL = '010-8888-8888', BUSEO_ID = 1, JIKWI_ID = 1, BASICPAY = 900000, SUDANG = 102000
WHERE EMP_ID = '1001'
;
...
SELECT CITY_NAME FROM TBL_CITY WHERE CITY_ID = (SELECT CITY_ID FROM TBL_EMP)
;
...
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) 
VALUES (EMPSEQ.NEXTVAL, '채다선', '961023-2111111', TO_DATE('2001-10-10', 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울')
        , '011-4151-4444'
        , (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부')
        , (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '대리')
        , 900000 , 102000);
-- 한 줄 구성
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '채다선', '961023-2111111', TO_DATE('2001-10-10', 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울'), '011-4151-4444', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '대리'), 900000 , 102000)
;
--==> 1 행 이(가) 삽입되었습니다.
...
-- 7. 전체 직원 리스트 조회 쿼리문
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, TO_CHAR(E.IBSADATE, 'YYYY-MM-DD') AS IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, (E.BASICPAY + E.SUDANG) AS PAY
...
--> 한 줄 구성
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, TO_CHAR(E.IBSADATE, 'YYYY-MM-DD') AS IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, (E.BASICPAY + E.SUDANG) AS PAY FROM TBL_EMP E, TBL_CITY C, TBL_BUSEO B, TBL_JIKWI J WHERE E.CITY_ID = C.CITY_ID AND E.BUSEO_ID = B.BUSEO_ID AND E.JIKWI_ID = J.JIKWI_ID
;
...
;
SELECT COUNT(*) AS COUNT FROM EMPVIEW WHERE EMP_NAME='채다선'
;
...
-- 9-1. 전화번호 없는 직원들을 위한 쿼리문 수정
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_NAME, NVL(TEL,'번호 없음') AS TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY
FROM EMPVIEW;
--> 한 줄 구성
...
;
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_NAME, NVL(TEL,'번호 없음') AS TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW WHERE EMP_NAME='채다선'
;
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_NAME, NVL(TEL,'번호 없음') AS TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW WHERE BUSEO_NAME='개발부'
;
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_NAME, NVL(TEL,'번호 없음') AS TEL, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW WHERE JIKWI_NAME='대리'
;
...
WHERE EMP_ID=1001;
--> 한 줄 구성
DELETE FROM TBL_EMP WHERE EMP_ID=1064
;
